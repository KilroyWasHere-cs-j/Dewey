		...
		<main class={mainClass}>
			...
			<div class="flex items-center justify-between">
				<div>
					...
					<p class="text-sm text-gray-500">Changes save instantly to your browser.</p>
				</div>
				<div class="flex items-center gap-3">
					...
					{/if}
					<button
						class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 shadow-sm hover:bg-gray-50"
						onclick={reset}
					>
						Reset to defaults
					</button>
			...
			<!-- ── Behavior ── -->
			<section class="space-y-6 rounded-2xl bg-white p-6 shadow-sm">
				<h2 class="text-xs font-semibold tracking-wider uppercase {headingClass}">Behavior</h2>

				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Metrics Poll Interval</p>
						<p class="text-sm text-gray-500">How often the dashboard and analytics pages refresh.</p>
					</div>
					<div
						class="flex shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-gray-50"
					>
				...
				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Analytics History Window</p>
						<p class="text-sm text-gray-500">How many data points the sparkline charts keep.</p>
					</div>
					<div
						class="flex shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-gray-50"
					>
				...
				<div class="flex items-center justify-between">
					<div>
						<p class="font-medium text-gray-700">Prometheus Alert Banner</p>
						<p class="text-sm text-gray-500">Show the red banner when Prometheus is unreachable.</p>
					</div>
					<button
						role="switch"
				...
				<div class="flex items-center justify-between">
					<div>
						<p class="font-medium text-gray-700">Default Sidebar State</p>
						<p class="text-sm text-gray-500">Whether the sidebar starts open or collapsed.</p>
					</div>
					<button
						role="switch"
				...
				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Layout Density</p>
						<p class="text-sm text-gray-500">Controls padding and spacing throughout the app.</p>
					</div>
					<div
						class="flex shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-gray-50"
					>
			...
			<section class="space-y-6 rounded-2xl bg-white p-6 shadow-sm">
				...
				<div class="flex items-center justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">RAM Alert Threshold</p>
						<p class="text-sm text-gray-500">Warn when RAM usage exceeds this value.</p>
					</div>
					<div class="flex shrink-0 items-center gap-2">
						<input
							type="number"
							min="0"
							class="w-24 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-right text-sm"
				...
				<div class="flex items-center justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Retry Alert Threshold</p>
						<p class="text-sm text-gray-500">Warn when file retries exceed this count.</p>
					</div>
					<div class="flex shrink-0 items-center gap-2">
						<input
							type="number"
						...
						/>
						<span class="text-sm text-gray-500">retries</span>
					</div>
				</div>
			</section>
			...
			<section class="space-y-6 rounded-2xl bg-white p-6 shadow-sm">
				...
				<div class="flex items-center justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Portal Name</p>
						<p class="text-sm text-gray-500">The name shown in the topbar header.</p>
					</div>
					<input
						type="text"
						maxlength="24"
						class="w-48 shrink-0 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm"
				...
				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Accent Color</p>
						<p class="text-sm text-gray-500">Used for dashboard cards and highlights.</p>
					</div>
				...
				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-medium text-gray-700">Chart Color Theme</p>
						<p class="text-sm text-gray-500">Color palette used by analytics charts.</p>
					</div>
					<div class="flex shrink-0 gap-2">
